...
public interface RenderVisitor {
	...
	void sendCreateUpdate(MeshObject meshObject);
	...
	void sendInstanceUpdate(MeshObject meshObject, Matrix4f newTransform);
	...
	void sendDeleteUpdate(MeshObject meshObject);
